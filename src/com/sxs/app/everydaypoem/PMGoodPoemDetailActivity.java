...
public class PMGoodPoemDetailActivity extends Activity {
    ...
    @ViewInject(R.id.ab_pm_good_detail_activity)
    private BaseActionBar bar;
    @ViewInject(R.id.tv_good_poem_text)
    private TextView text;
    @ViewInject(R.id.tv_good_poem_web)
    private WebView web;
    ...
    protected void onResume() {
        ...
        if (isFirst) {
            ...
            if (UserDataModel.instance().poem != null) {
                ...
                bar.setTitle(MapStringUtil.getStr(UserDataModel.instance().poem
                        .get("title")));
                text.setText("作者："
                        + MapStringUtil.getStr(UserDataModel.instance().poem
                                .get("author")));
                String str = "<p>"
                        + MapStringUtil.getStr(UserDataModel.instance().poem
                                .get("content")) + "</p>";
                String translate = MapStringUtil.getStr(UserDataModel
                        .instance().poem.get("translate"));
                if (translate.length() > 0) {
                    str += translate;
                }
                web.loadData(str.replace("<p>",
                        "<p style=\"line-height:180%; color: #4a4a4a\">"),
